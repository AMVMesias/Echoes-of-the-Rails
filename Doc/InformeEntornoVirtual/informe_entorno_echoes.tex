...
El escenario de \textit{El Paso de la Bruma} trabaja una identidad visual \textit{Retro Realism}: modelos de baja poligonización, texturas simples, colores contenidos, luces cálidas puntuales y niebla atmosférica. Esta estética ayuda a que el entorno sea viable en VR y mantenga una personalidad nostálgica.
...
La iluminación se mantiene tenue para que las farolas, la estación y la cabina tengan protagonismo. En el recorrido de Blender, las farolas acompañan los postes y ayudan a leer los bordes de la vía sin invadir el espacio central de circulación.
...
\begin{itemize}
  \item \textbf{Primer plano:} locomotora, vagones y cabina VR, donde el jugador toma decisiones.
...
\midrule
\endhead
Locomotora y vagones & Vehículo del jugador y silueta central del juego. La locomotora frontal evita que el tren parezca un único vagón aislado.\\
...
\caption{Locomotora y vagones dentro del entorno actual, integrados con estación, árboles, postes y niebla.}
\end{figure}
