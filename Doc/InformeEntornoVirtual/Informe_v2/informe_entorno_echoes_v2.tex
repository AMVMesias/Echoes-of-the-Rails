...
\begin{flushleft}
\includegraphics[width= 0.7º cm]{../figures/image.png}
\vspace{0.4cm}
...
{\bfseries Tarea I -- Parcial II\par}
\vspace{0.3cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.96\textwidth]{../figures/figura_elemento_farolas.png}
\caption{Plano medio decorativo: farolas y postes como guía visual del corredor ferroviario en condiciones de baja iluminación.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.96\textwidth]{../figures/figura_elemento_montanas.png}
\caption{Plano de fondo decorativo: composición de montañas y bosque para profundidad visual y lectura del relieve de la ruta.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.96\textwidth]{../figures/figura_elemento_NPCs_Estacion.png}
\caption{Plano medio interactivo en estación: integración de NPCs y andén como referencia de abordaje y salida de pasajeros.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.96\textwidth]{../figures/figura_interior_cabina.jpeg}
\caption{Interior de cabina en operación: integración de medidores, controles y lectura de carbón para la toma de decisiones en ruta.}
\end{figure}
